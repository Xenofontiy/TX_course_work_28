    ...
    class Exhibitions
    {
        ...
        public Exhibitions(int mode)
        {
            if (mode == 0)
            {
                ...
                interfacee VincentvanGoghST = new Hall1("Зал 1", "Звездная ночь", "Год: 1889, Данные:73.0x92.0 см. ");
            ...
            if (mode == 1)
            {
                interfacee LeonardodaVinciAn = new Hall2("Зал 2", "Благовещение", "Год: 1472, Данные: Дерево, масло. 98 × 217 см ");
            ...
            if (mode == 2)
            {
                interfacee OscarClaudeMonetIm = new Hall3("Зал 3", "Впечатление. Восход солнца", "Год:1872, Данные: масло, холст, 63 x 48 см ");
            ...
            if (mode == 3)
            {
                interfacee JanVermeerGl = new Hall4("Зал 4", "Бокал вина", "Год: 1658 - 1660, Данные: масло, холст, 66,3 x 76,5 см  ");
            ...
            if (mode == 4)
            {
                interfacee PaulCezanneSt = new Hall5("Зал 5", "Натюрморт с черепом", "Год: 1866, Данные: масло, холст");
